...
public class OtherNotificationsActivity extends AppCompatActivity {
    ...
    private void setupDemoReadState() {
        View cardOne = findViewById(R.id.cardOtherOne);
        TextView badgeOne = findViewById(R.id.badgeOtherOne);
        Button markOne = findViewById(R.id.btnMarkReadOtherOne);

        markOne.setOnClickListener(v -> markCardAsRead(cardOne, badgeOne, markOne));

        findViewById(R.id.btnMarkAllReadOther).setOnClickListener(v ->
